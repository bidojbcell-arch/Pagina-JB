    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100"
          placeholder="Características, colores disponibles, garantía, etc."
        />
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100"
            placeholder="Dejar vacío = Consultar precio"
          />
        </div>
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-slate-400">
          Puedes subir varias fotos. La primera será la portada en el catálogo.
        </p>
      </div>
      ...
      <div className="flex gap-3">
        <button
          type="submit"
          disabled={guardando}
          className="rounded-xl bg-brand-600 px-6 py-2.5 font-semibold text-white shadow hover:bg-brand-700 disabled:opacity-60"
        >
          {guardando ? "Guardando..." : esEdicion ? "Guardar cambios" : "Publicar producto"}
        </button>
        <button
          type="button"
          onClick={() => router.push("/admin")}
          className="rounded-xl border border-slate-200 px-6 py-2.5 font-medium text-slate-600 hover:bg-slate-50"
        >
          Cancelar
        </button>
      </div>
